...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_p11.setText(_translate("MainWindow", "上一步"))
        self.pushButton_p12.setText(_translate("MainWindow", "下一步"))
        self.pushButton_p13.setText(_translate("MainWindow", "退出"))
        ...
        self.pushButton_1.setText(_translate("MainWindow", "1 阈值抠图"))
        self.pushButton_2.setText(_translate("MainWindow", "2 HSV抠图"))
        self.pushButton_3.setText(_translate("MainWindow", "3 轮廓提取"))
        self.pushButton_4.setText(_translate("MainWindow", "4 边缘检测"))
        self.pushButton_5.setText(_translate("MainWindow", "5 Bayesian 抠图"))
        self.pushButton_6.setText(_translate("MainWindow", "6 Poisson 抠图"))
