...
class MyMainWindow(QMainWindow, Ui_MainWindow):  # 继承 QMainWindow 类和 Ui_MainWindow 界面类
    ...
    def click_pushButton_4(self):    # 边缘检测，点击 pushButton_04 触发
        self.lineEdit.setText("边缘检测")
        self.plainTextEdit.appendPlainText("边缘检测")
    ...
    def click_pushButton_5(self):  # 轮廓查找，点击 pushButton_05 触发
        self.lineEdit.setText("轮廓查找")
        self.plainTextEdit.appendPlainText("轮廓查找")
        self.label_2.setPixmap(QtGui.QPixmap(""))
        self.label_2.setScaledContents(True)  # 图片自适应 QLabel 区域大小
        return

    def click_pushButton_6(self):  # 图像分割，点击 pushButton_06 触发
        self.plainTextEdit.appendPlainText("图像分割")
